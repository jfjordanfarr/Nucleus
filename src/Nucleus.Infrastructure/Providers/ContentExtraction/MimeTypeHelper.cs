...
using Nucleus.Abstractions.Extraction; // For IContentExtractor (referenced in XML docs)
...
public static class MimeTypeHelper
{
    ...
    /// <summary>
    /// Gets the Dependency Injection key for the appropriate <see cref="Nucleus.Abstractions.Extraction.IContentExtractor"/> based on the provided MIME type.
    /// </summary>
    ...
    /// <summary>
    /// Tries to get the Dependency Injection key for the appropriate <see cref="Nucleus.Abstractions.Extraction.IContentExtractor"/>.
    /// </summary>
