...
6. **Output Ownership** – Users retain control of all generated artifacts (reports, learning materials, etc.). Nucleus does not store these outputs except in the optional Phase 5 "Public Good" repository where content is explicitly shared.
